...
void bresenham_circle1(int xc, int yc, int R)
{
  ...
  glVertex2i(xc+y-15, yc-x);  
  glVertex2i(xc+x-15, yc-y);  
  glVertex2i(xc-x-15, yc-y);  
  glVertex2i(xc-y-15, yc-x); 
...
void Menu(int ch){
  switch(ch){
	...
	bresenham_circle2(xc, yc, R+15);
	bresenham_circle1(xc, yc, R+30);
	bresenham_circle2(xc, yc, R+45);
	bresenham_circle1(xc, yc, R+60);
	bresenham_circle2(xc, yc, R+75);
	glFlush();	
            break;
